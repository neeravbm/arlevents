...
<?php /* ?> <div class="member_email"><?php if(!$field_keep_email_private) { print $account->mail; } ?></div>
<div class="member_phone"><?php if(!$field_keep_phone_number_private) { print @$account->field_user_primary_phone['und'][0]['value']; }  ?></div> <?php */ ?>
