...
module_load_include('php', 'arl_badge', 'Zend/Pdf/Canvas/Interface');
...
module_load_include('php', 'arl_badge', 'Zend/Pdf/Resource/GraphicsState');
module_load_include('php', 'arl_badge', 'Zend/Pdf/Resource/Font');
module_load_include('php', 'arl_badge', 'Zend/Pdf/Resource/Image');
/**
