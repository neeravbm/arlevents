...
module_load_include('php', 'arl_badge', 'Zend/Pdf/Page');

/** Zend_Pdf_Style */
/*require_once 'Zend/Pdf/Style.php';*/
module_load_include('php', 'arl_badge', 'Zend/Pdf/Style');


/** Zend_Pdf_Color_GrayScale */
/*require_once 'Zend/Pdf/Color/GrayScale.php';*/
module_load_include('php', 'arl_badge', 'Zend/Pdf/Color/GrayScale');

/** Zend_Pdf_Color_Rgb */
/*require_once 'Zend/Pdf/Color/Rgb.php';*/
module_load_include('php', 'arl_badge', 'Zend/Pdf/Color/Rgb');

/** Zend_Pdf_Color_Cmyk */
/*require_once 'Zend/Pdf/Color/Cmyk.php';*/
module_load_include('php', 'arl_badge', 'Zend/Pdf/Color/Cmyk');

/** Zend_Pdf_Color_Html */
/*require_once 'Zend/Pdf/Color/Html.php';*/
module_load_include('php', 'arl_badge', 'Zend/Pdf/Color/Html');

/** Zend_Pdf_Image */
/*require_once 'Zend/Pdf/Image.php';*/
module_load_include('php', 'arl_badge', 'Zend/Pdf/Image');

/** Zend_Pdf_Font */
/*require_once 'Zend/Pdf/Font.php';*/
module_load_include('php', 'arl_badge', 'Zend/Pdf/Font');

/** Zend_Pdf_Resource_Extractor */
/*require_once 'Zend/Pdf/Resource/Extractor.php';*/
module_load_include('php', 'arl_badge', 'Zend/Pdf/Resource/Extractor');

/** Zend_Pdf_Canvas */
/*require_once 'Zend/Pdf/Canvas.php';*/
module_load_include('php', 'arl_badge', 'Zend/Pdf/Canvas');
...
*/
module_load_include('php', 'arl_badge', 'Zend/Pdf/Element');
module_load_include('php', 'arl_badge', 'Zend/Pdf/Element/Array');
module_load_include('php', 'arl_badge', 'Zend/Pdf/Element/String/Binary');
module_load_include('php', 'arl_badge', 'Zend/Pdf/Element/Boolean');
module_load_include('php', 'arl_badge', 'Zend/Pdf/Element/Dictionary');
module_load_include('php', 'arl_badge', 'Zend/Pdf/Element/Name');
module_load_include('php', 'arl_badge', 'Zend/Pdf/Element/Null');
module_load_include('php', 'arl_badge', 'Zend/Pdf/Element/Numeric');
module_load_include('php', 'arl_badge', 'Zend/Pdf/Element/String');
  ...
  /**** Class Constants ****/
    ...
    public function __construct($source = null, $revision = null, $load = false)
    {
       /* require_once 'Zend/Pdf/ElementFactory.php';*/
          module_load_include('php', 'arl_badge', 'Zend/Pdf/ElementFactory');     
        ...
        if ($source !== null) {
          ...
          /*  require_once 'Zend/Pdf/Trailer/Generator.php';*/
              module_load_include('php', 'arl_badge', 'Zend/Pdf/Trailer/Generator');
